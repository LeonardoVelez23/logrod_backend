...
router.get('/stats', restrictTo('admin', 'empleado', 'cajero', 'cocinero'), getPedidoStats);
router.get('/', restrictTo('admin', 'empleado', 'cajero', 'cocinero', 'mesero'), getAllPedidos);
router.get('/:id', getPedidoById);
router.post('/', restrictTo('cliente', 'admin', 'empleado', 'cajero', 'cocinero', 'mesero'), createPedido);
